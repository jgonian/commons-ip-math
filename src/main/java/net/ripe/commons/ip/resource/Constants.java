...
public final class Constants {
    ...
    public static final Ipv4Address FIRST_IPv4_ADDRESS = Ipv4Address.of(IPv4_MINIMUM_VALUE);
    public static final Ipv4Address LAST_IPv4_ADDRESS = Ipv4Address.of(IPv4_MAXIMUM_VALUE);
